...
class MedicamentosPortalView(TemplateView):
    model = Materia
    template_name = "portal_saude/medicamentos_portal.html"

    def get_context_data(self, **kwargs):
        context = super(MedicamentosPortalView, self).get_context_data(**kwargs)
