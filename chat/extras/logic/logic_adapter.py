...
from chat.extras.utils import import_module
...
class LogicAdapter(Adapter):
    ...
    def __init__(self, **kwargs):
        ...
        from chat.extras.comparisons import levenshtein_distance
        from chat.extras.response_selection import get_first_response
